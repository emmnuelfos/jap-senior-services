...
(function () {
  ...
  window.JAP_PHOTOS = {
    ...
    careersHero:        { src: local('careersHero'),        alt: 'Confident African American nurse in pale blue scrubs and a stethoscope, smiling with arms folded in a sunlit senior community lobby', label: 'CAREERS · NURSE PORTRAIT', hue: 36 },
    blogResources:      { src: local('blogResources'),      alt: 'African American nurse in white tunic with stethoscope, holding a clipboard, smiling in a sunlit senior community common room', label: 'BLOG · RESOURCES', hue: 34 },
    faqsHelp:           { src: local('faqsHelp'),           alt: 'Young male caregiver in light blue scrubs gently steadying an elderly man with a cane in a bright modern kitchen', label: 'FAQ · HELPING HAND', hue: 32 },
    safetyCare:         { src: local('safetyCare'),         alt: 'Caregiver steadying an elderly woman as she walks down indoor stairs, fall-prevention support', label: 'SAFETY · STAIR ASSIST', hue: 32 },
    twentyfourCare:     { src: local('twentyfourCare'),     alt: 'Caregiver delivering a breakfast tray to a senior resting in a softly-lit bedroom — overnight presence', label: '24-HOUR · BREAKFAST TRAY', hue: 34 },
    wellnessCare:       { src: local('wellnessCare'),       alt: 'Caregiver helping a senior with a warm meal at a sunlit dining table — nutrition and well-being', label: 'WELLNESS · MEAL ASSIST', hue: 36 },
    techHelp:           { src: local('techHelp'),           alt: 'Smiling caregiver guiding an older gentleman through a tablet screen at home', label: 'TECHNOLOGY · TABLET COACHING', hue: 32 },
    respiteRelief:      { src: local('respiteRelief'),      alt: 'Senior woman warmly embracing her caregiver outdoors — moment of comfort and relief', label: 'RESPITE · EMBRACE', hue: 28 },
    nursingClinical:    { src: local('nursingClinical'),    alt: 'Close-up of pill organizer, blood-pressure cuff and care notes on a kitchen table — clinical home management', label: 'NURSING · MEDS', hue: 30 },
